...
<html>
<head>
<title>PDQ Flyers - member broadcast</title>
...
<meta NAME="Description" Content="This page is actually a request form which provides the requestor's email address, request details, and email message subject and content. It invokes a stand alone html page named broadcast-action.php which actually produces the member data list and issues the email according to the request.">
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=UTF-8">
<link type="text/css" rel="stylesheet" href="xsp_styles.css">
<link rel="canonical" href="http://www.pdqflyers.com/member-broadcast.php" /><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><p><span><span style="FONT-SIZE: 12pt"><span style="FONT-SIZE: 20pt"><strong><font color=
"#0000ff">Member&nbsp;Broadcast</font></strong></span></span></span></p>

<p>You can use the form below to prepare a broadcast message to the PDQ Flyers membership or to a special interest
group in the Club. To do this, your email address has to be included in the PDQ Flyers member data base and you
must be in the interest group&nbsp;to whom&nbsp;you wish to broadcast.&nbsp;</p>

<p>Your email is added to&nbsp;the data base when you complete the Application Process for your annual
membership.&nbsp; At this time, you can also indicate which interest groups you would like to be in, but if you
didn't and want to be added now, go to the Member Data Update page and modify your preferences.</p>

<p>To broadcast to the whole Club, a password is required.&nbsp; Contact the Club President for authorization&nbsp;
(the password will be changed annually).</p>

<p>When you have completed the&nbsp;data fields below, press "Send" and the broadcast message will be sent to all
active members of the Club.&nbsp; If you get an error message, you can use the back arrow key on your Browser page
to return to this page, where you can correct the problem and Send again.</p>

<form method="get"
      action="broadcast-action.php">
    <!-- comments --> 

    <p><strong><span>Your E-mail:&nbsp;</span></strong> <input name="email"><br>
    <br>
    <strong><span>Password:</span></strong>&nbsp; &nbsp; <input style="HEIGHT: 22px; WIDTH: 154px"
           maxlength="8"
           size="1"
           type="password"
           value=""
           name="clubpswd">&nbsp;<span style="FONT-SIZE: 10pt">(only required for Club Messages)</span></p>

    <p><strong><span>Request Instructions:</span></strong><br>
    <input checked
           type="checkbox"
           value="email_yes"
           name="group"><span>Send email</span><br>
    <input type="checkbox"
           value="grpname"
           name="group"><span>Provide member list</span><br>
    <input type="checkbox"
           value="grpname"
           name="group"><span>Provide comma separated member list</span></p>

    <p><strong><span>Interest Group:</span></strong><br>
    <input checked
           type="radio"
           value="grpname"
           name="group"><span>PDQ Flyers</span><br>
    <input type="radio"
           value="grpname"
           name="group"><span>Float Flyers</span><br>
    <input type="radio"
           value="grpname"
           name="group"><span>Indoor Flyers</span><br>
    <input type="radio"
           value="grpname"
           name="group"><span>Helicopters</span><br>
    <input type="radio"
           value="grpname"
           name="group"><span>Aerobatics</span></p>

    <p><strong><span>Subject:</span></strong><span>&nbsp;</span><input name="subject"></p>

    <p><strong><span>Message:</span></strong><span>&nbsp;</span> 
    <textarea rows="10"
              cols="80"
              name="message">
This area is intended for shorter broadcast messages and does not have format functionality. Messages longer than 512 characters (including spaces) will not produce an error, but will result in a blank messsage. Please paste or type your message over top of this one. If you have a typo on the email or password and get an error message, use the Browser back arrow key to re-do.
