...
<html>
<head>
<title>PDQ Flyers - Help - General</title>
...
<meta NAME="Description" Content="All of the tutorials are done with Jing. To get the embedded code, add a button for html using Jing preferences. The html code is put onto the clipboard, so just paste it in the source view.">
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=UTF-8">
<link type="text/css" rel="stylesheet" href="xsp_styles.css">
<link rel="canonical" href="http://www.pdqflyers.com/help-general.php" /><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<tr><td>
 ...
 <span class="xsp1INFO_BAR_MENU"><a class="mainlinksINFO_BAR_MENU" href="help-general.php" target="">Help&nbsp;-&nbsp;General</a></span>
 ...
 <span class="xsp1INFO_BAR_MENU"><a class="mainlinksINFO_BAR_MENU" href="rss-message.php" target="">RSS&nbsp;Message</a></span>
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><p><span style="FONT-SIZE: 20pt"><font color="#0000ff"><strong>Help</strong></font></span></p>

<p>Although I have tried to make this website as easy to use as possible, some of you might have challengs with a
couple of things. To make it easier, I have created a few "tutorials" (sub-pages to this page) to show you how a
few things work.&nbsp; Just click on the video, watch, and listen.&nbsp; When I use these things, I use the
stop/start button a lot so that I can go to another window and do what I'm seeing at the same time.</p>

<p>If you have any trouble with anything that I didn't think of, please leave a comment on "<a href=
"contact-us.php">Contact us</a>" page and I will see if I can add another tutorial.</p>

<h4 class="bold_large">PDQ News Flashes Featured on igHome</h4>

<p class="bold_large"><span style="FONT-SIZE: 12pt">If you haven't set up&nbsp;a custom home page&nbsp;on your
computer browser (Explorer, Firefox, etc), I highly recommend it.&nbsp; In addition to getting all manner of news,
games, comics, and a variety of other broadcasts from&nbsp;websites all over the internet world, you can get the
latest&nbsp;PDQ broadcasts on flying field closures and upcoming events.</span></p>

<p class="bold_large"><font size="3">I&nbsp;use a program called igHome, which replaced iGoogle when Microsoft
abandoned it. Find igHome on the internet and follow instructions to download and install it. Once you have done
that you can organize the various "gadgets" (RSS feeds from various websites) until they are layed out the way you
like. &nbsp;Personally, I subscribe to several different newspapers and each morning take a look to see what I
might want to read. Of course, I include Calvin and Hobbes so that I don't miss that daily comic strip!</font></p>

<p class="bold_large"><span style="FONT-SIZE: 12pt">Make sure that you also click on the&nbsp;option in&nbsp;your
Browser&nbsp;that says "make igHome my home page".</span></p>

<p class="bold_large"><font size="3">Once you have set up your igHome home page, you can click on this address and
it will add the PDQ News Flash to your page:</font></p>

<p class="bold_large"><a href="http://www.pdqflyers.com/newsflash/xc_rss/rss-to-igoogle.rss"><font size=
"3">www.pdqflyers.com/newsflash/xc_rss/rss-to-igoogle.rss</font></a></p>

<p class="bold_large"><font size="3">News that is posted by the PDQ PR Guy will be seen on iGoogle within a few
hours from posting (unfortunately we have to wait for Google robots to "find" us). However, this will be enough
time for a few days advance warning of an upcoming field closure or event advisory.</font></p>
</td></tr></table></td>
