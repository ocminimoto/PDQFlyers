...
//the password is fixed.  For 2017 it is "nokidding".
if ($data_pswd <> "nokidding") {die("Your password is incorrect, use the back arrow on your Browser to go back and correct your input.");}
