...
<html>
<head>
<title>PDQ Flyers - Club News</title>
...
<meta NAME="Description" Content="Notes: RSS feeds are done manually. Open the xml application and then open the file &quot;PDQ-feed&quot;. Add or delete items as needed according to thte notes in the document and then save in Smith files/RSS with the name &quot;PDQRSS-feed&quot;. Use ftp program to move it to PDQ/public_html/RSS. Check that everything is working with igHome.">
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=UTF-8">
<link type="text/css" rel="stylesheet" href="xsp_styles.css">
<link rel="canonical" href="http://www.pdqflyers.com/club-news.php" /><!-- Start WOWSlider.com HEAD section -->
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><h1>Club News</h1>

<h2>Weather Link</h2>

<p>Click <a href="field-locations.php">here</a>&nbsp;to go directly to the Weather page.</p>

<h2>Indoor Flying</h2>

<p wrap="">Hi Guys,</p>

<p wrap="">For those that are interested the indoor flying schedule for the 2018/2019 season is as follows:</p>
...
<p wrap="">I am sorry for the big gap in December, but due to office parties and other stuff it couldn't be
avoided. We however do get to have 12 sessions due to January having 3 in it, so it worked out as per every other
year.</p>

<p wrap=""><span style="FONT-SIZE: 10pt"><em>Submitted by Jim Sheppard, September 3rd<font color="#000000">,
2018</font></em></span></p>

<h2>Bipes and Stunts Day, 2018</h2>

<p>The Bipes and Stunts Day Event, which was held on July 21st, has its own page under PDQ Events. Click
   <a href="stunt-day-2018.php">here</a>&nbsp;to go to it.</p>

<h2>Bill Martin Memorial Scale Event 2018</h2>

<p>The Scale Event held on June 23rd has its own page under PDQ Events. Click <a href=
"scale-2018.php">here</a>&nbsp;to go to it.</p>
</td></tr></table></td>
