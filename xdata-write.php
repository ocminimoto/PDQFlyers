...
<input type = "radio" name="member_type" value = "full" <?php echo 'checked="checked"'; ?> <label>  Full Member</label> (Renewal fee is $75)
...
<br>
<input type = "radio" name="member_type" value = "junior" <label>  Junior Member/label> (Fee is $25)&nbsp;&nbsp; 
