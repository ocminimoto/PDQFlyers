...
<html>
<head>
<title>PDQ Flyers - Simulators</title>
...
<link rel="canonical" href="http://www.pdqflyers.com/simulators.php" /><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><p><span style="FONT-SIZE: 20pt"><font color="#0000ff"><strong>Simulators</strong></font></span></p>

<p>Simulators are a major assist in learning to fly and very helpful in learning new aerobatic maneuvers. These
tools vary in capabilities and requirements and there are several available on the market. These include:</p>

<ul>
    <li>Dynam 6CH 3D USB RC Flight Simulator Controller For Heli Helicopter Airplane Glider</li>

    <li>Tech 6 CH Flight Simulator Remote Control w/ Software for Helicopters/ Airplanes</li>

    <li>E-Sky 4 CH Flight Simulator Training Kit For Rc Airplanes and rc Helicopters</li>

    <li>Great Planes RealFlight G5.5 RC Flight Simulator</li>

    <li>Phoenix R/C Pro Simulator</li>

    <li>SKYARTEC R/C Plane Master X-Power Helicopter, Airplane and Glider Flight Simulator Ikarus AeroFly Pro
    Deluxe RC Flight Simulator</li>
</ul>

<p>Some websites that might be useful:</p><a href=
"http://www.rchelisite.com/choosing_an_rc_helicopter_flight_simulator.php"
      target="_new"></a> 

<ul>
    <li><a href="http://www.rchelisite.com/choosing_an_rc_helicopter_flight_simulator.php"
       target="_new">RC Helisite</a>&nbsp;</li>

    <li><a href="http://radiocontrolpilot.com/rc-flight-simulator-review-realflight-g45/"
       target="_new">RadioControlPilot.com</a>&nbsp;</li>

    <li><a href="http://www.rchelisite.com/choosing_an_rc_helicopter_flight_simulator.php"
       target="_new"></a><a href="http://www.rc-airplane-world.com/phoenix-rc-flight-simulator.html"
       target="_new">R/C Airplane World</a>&nbsp;</li>
</ul>

<p>Many of our members and all of our beginners will be very interested in your experiences with any of these (or
any other) flight simulators. If you have used a flight simulator, could you please&nbsp;send an email to
   <a href="mailto://ian@somesmiths.com">Ian Smith</a> to&nbsp;tell us what you think?</p>
