...
<html>
<head>
<title>PDQ Flyers - Pre-season Check Out</title>
...
<link rel="canonical" href="http://www.pdqflyers.com/pre-season-check-out.php" /><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><p><strong><font color="#0000ff"><span style="FONT-SIZE: 20pt">Pre-season</span><span style=
"FONT-SIZE: 20pt">&nbsp;check out</span></font></strong></p>

<p><span style="FONT-SIZE: 12pt">This year before your first flight of the day there are a few things that you need
to check on your model to insure a safe flight.</span></p>

<ol style="FONT-SIZE: 12pt">
    <li><span class="PDQ_text_medium"
          style="FONT-SIZE: 12pt">Before you turn on radio</span><span style="FONT-SIZE: 12pt">&nbsp;place proper
          channel marker on the frequency board. Range check radio, collapse antenna and walk 75' - 100' at least,
          you should have full control of surfaces and no interface.</span>&nbsp;</li>

    <li><span class="PDQ_text_medium"
          style="FONT-SIZE: 12pt">Are the batteries charged</span><span style="FONT-SIZE: 12pt">&nbsp;do the
          batteries need to be replaced, cycle the batteries with a discharger to insure they are up to the job. Do
          not fly batteries that read lower than 4.8 volts when tested with 1amp load.</span>&nbsp;</li>

    <li><span class="PDQ_text_medium"
          style="FONT-SIZE: 12pt">Are all screws</span><span style="FONT-SIZE: 12pt">&nbsp;linkages, wire
          connections tight? Make sure the muffler &amp; carburetor, back plate screws have not worked
          loose.</span>&nbsp;</li>

    <li><span class="PDQ_text_medium"
          style="FONT-SIZE: 12pt">Grab the flight box</span><span style="FONT-SIZE: 12pt">&nbsp;and bring the
          entire hanger out for the day!. Have a safe flight and remember that the take off is optional, the
          landing is mandatory.</span>&nbsp;</li>
</ol>
</td></tr></table></td>
