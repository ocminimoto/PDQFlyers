...
<link rel="canonical" href="http://www.pdqflyers.com/tools.php" /><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><h1>Tools</h1>

<h2>eMail Broadcast</h2>

<p>The function "<a href="email-broadcast.php">eMail Broadcast</a>" has been provided to allow any member to send
an email to all of the members of a Special Interest Group, provided that he/she is a member of that group.</p>

<p>To send an eMail to all Club members, a password is required, as this is only used by the Executive for Club
business.</p>

<h2>Member Data Reports</h2>

<p>For those who need a report listing all member data,&nbsp;the online report with print capability, "<a href=
"member-data-access.php">Member Data Access</a>"&nbsp;has been provided for Executive use.&nbsp; A password is
required.</p>
