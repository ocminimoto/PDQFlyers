...
<html>
<head>
<title>PDQ Flyers - Fun Fly - 2012</title>
...
<link rel="canonical" href="http://www.pdqflyers.com/fun-fly-2012.php" /><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><p><span><font color="#0000ff"><span style="FONT-SIZE: 20pt"><strong><span style="FONT-SIZE: 20pt">Fun Fly&nbsp;-
2012</span></strong></span></font></span></p>

<p>Saturday, June 2nd - 2012</p>

<h3>Prize Winners</h3>

<p>&nbsp;<img title="Fun Fly Finalists - 2012"
     style="HEIGHT: 463px; WIDTH: 700px"
     border="0"
     alt="Fun Fly Finalists - 2012"
     src="images/funfly%202012%20finalists.JPG"></p>

<h3>The Event</h3>

<p><span>The PDQ Flyers have been hosting a Spring Fun fly for as long as I can remember. This is one event where
the food and fun is on us, all we ask is that you enjoy yourself and fly safe.</span></p>

<p><span><span>The events are designed so that's there's something for everyone, fly one event or fly them all, the
choice is yours. &nbsp;While a fun fly is a competetive event, the PDQ version is a little different.&nbsp; While
we still keep track of your scores and overall standing, they have no bearing on prizes given out at the end
-&nbsp;that is left to a raffle to decide.&nbsp;</span></span> <span><span>Competition takes a back seat to
FUN!!!</span></span></p>

<p><span><span>I would like to thank everyone who came out this year and helped to make the event a sucsess. Also a
BIG thank you to Rusty, Bruce, and Greg who came out the day before to mow and to get the field looking
great.&nbsp; Thanks to Brian for manning the BBQ&nbsp;(the dogs were great) and thanks to all who helped on the
flight line.</span></span></p>

<p><span><span>A special thanks goes out to Beaver Creek Hobbies and Dan Dawes for the prizes that were
donated.</span></span></p>

<p><span><span>Hope to see you all again next year!!&nbsp;</span></span></p>

<p>Steve Hughes</p>

<h3>Results</h3>

<p>Most loops in 1 Minute:</p>

<ul>
    <li>1st. Bill Rollins</li>

    <li>2nd. Steve Hughes</li>

    <li>3rd. Peter Jubb</li>

    <li>4th. Bill Martin/ Ross Donogh</li>

    <li>5th. Brian Coolican</li>

    <li>6th. Geoff Graham</li>

    <li>7th. Jim Sheppard</li>

    <li>8th. Charlie Hathaway</li>
</ul>

<p>Fastest 3 loops, 3rolls:&nbsp;</p>

<ul>
    <li>1st. Bill Rollins</li>

    <li>2nd. Bill Martin</li>

    <li>3rd. Steve Huges</li>

    <li>4th. Brian Coolican</li>

    <li>5th. Peter Jubb</li>

    <li>6th. Geoff
    Graham&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>

    <li>7th. Ross Donogh</li>
</ul>

<p>Spot landing:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>

<ul>
    <li>1st. Peter Jubb</li>

    <li>2nd. Bill Rollins</li>

    <li>3rd. Bill Martin</li>
...
<ul>
    <li>1st. Geoff Graham</li>

    <li>2nd. Bill Rollins</li>

    <li>3rd. Ross&nbsp;Donogh</li>

    <li>4th. Jim Sheppard</li>
    ...
    <li>7th. Bill Martin</li>

    <li>8th. Brian Coolican</li>

    <li>9th. Charlie Hathaway</li>
</ul>

<p>Pylon Race, 5 Laps:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
...
<ul>
    ...
    <li>3rd. Brian Coolican/ Ross Donogh&nbsp;</li>

    <li>4th. Bill Martin</li>

    <li>5th. Bill Rollins</li>

    <li>6th. Leo Katila</li>

    <li>7th. Geoff Graham&nbsp;</li>
</ul>
</td></tr></table></td>
