...
<html>
<head>
<title>PDQ Flyers - mail test</title>
...
<link rel="canonical" href="http://www.pdqflyers.com/mail-test.php" /><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><p><span><span style="FONT-SIZE: 12pt"><span style="FONT-SIZE: 20pt"><strong><font color="#0000ff">Member&nbsp;List
Generator</font></strong></span></span></span></p>

<p>The embedded php code&nbsp;generates&nbsp;a PDQ Flyers member list&nbsp;below.&nbsp; Copy it and paste it into
Excel or Word.</p><?php
/* 

When you click your submit button, it will reload your page with input from the form. So write your PHP code at
the top of the form. 
Logic: 1. get the users email address 
2. get the email addresses from the data base where
interest group matches 
3. set $validemail to false, then loop through email addresses, changing $validemail to true
when match is found and creating the distribution list 
4. if the distribution is the Club, need a password to use this
5. send
the email with the addressee "bcc" 
6. put requestor's email in "from"
...
$strSQL = "SELECT * FROM members WHERE MAAC = '24185'";
...
// and then send it
// mail ('ian@somesmiths.com', 'test from php', $message);

// close the data base
mysql_close();

/*
if (isset ($_GET['submit'])) { $email = htmlentities($_GET['val2']); } else $email = "nothing";

echo $email;
//$result = myFunction($val1, $val2);  ;
//echo "result is $result - did you get it";
...
<form action="email-action.php" method="post">
 ...
 <p>Your age: <input type="text" name="password" /></p>
