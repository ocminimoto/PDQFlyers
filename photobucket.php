...
<html>
<head>
<title>PDQ Flyers - PhotoBucket</title>
...
<link rel="canonical" href="http://www.pdqflyers.com/photobucket.php" /><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><div id="START_OF_PINEDIT_PAGE">
    <span style="FONT-SIZE: 20pt"><strong><font color="#0000ff">Photo Central</font></strong></span>
</div>

<h4>Tools</h4>

<p>We wanted to make it easy for Members to upload their photos to the web for general viewing so that those who
weren't&nbsp;at that particular event&nbsp;can get a feel for what happened as well.</p>

<p>After an extensive search of album management software/services available to&nbsp;provide PDQ Flyers Member's
photo managment needs, Photobucket was selected&nbsp;as the best candidate.&nbsp; It is simple to use, has no
limits on what we put on their servers, shows&nbsp;slideshows well, and is free.&nbsp; It is quite easy to share
photographs and, as you can see below, easy for&nbsp;the Webmaster&nbsp;to add slideshows to our website.&nbsp; For
those of you who find new techy things challenging, please refer to the <a href=
"set-up-photobucket.php">Help&nbsp;- Set&nbsp;up Photobucket</a>&nbsp;tutorial to get started.</p>

<p><span style="FONT-SIZE: 12pt">By the way, Photobucket is&nbsp;not just for PDQ related photos, you can
use&nbsp;it to keep and manage&nbsp;all your personal photos which you can&nbsp;then share with family and
friends.</span></p>

<p>A PDQ Photobucket account has been established: <a href="http://s772.photobucket.com/albums/yy5/pdqflyers/"
   target="_new">pdqflyers</a>.&nbsp; All of our history of photos has been loaded into it.</p>

<h4>Photo Albums</h4>

<p>This balance of this section of the site is a&nbsp;recap and pointer to&nbsp;of all of the photos that have been
loaded onto Photobucket by members. In each case, there is a direct link to the photo album where you can view
