...
<html>
<head>
<title>PDQ Flyers - email action</title>
...
<link rel="canonical" href="http://www.pdqflyers.com/email-action.php" /><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><?php $email =  htmlspecialchars($_POST['email']);  

$passord = htmlspecialchars($_POST['password']);  
