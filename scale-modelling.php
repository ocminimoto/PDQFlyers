...
<html>
<head>
<title>PDQ Flyers - Scale Modelling</title>
...
<link rel="canonical" href="http://www.pdqflyers.com/scale-modelling.php" /><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><p><strong><font color="#0000ff"><span style="FONT-SIZE: 20pt">Scale Modelling</span></font></strong></p>

<p><span style="FONT-SIZE: 12pt">This section is for items of interest to those who want to build and fly models of
current or historical aircraft.</span></p>

<h2><span style="FONT-SIZE: 12pt">War Birds Information Exchange</span></h2>

<p><span style="FONT-SIZE: 12pt">If you're interested in the special area of scale modeling related to War Birds,
take a look at <a href=
"http://www.warbirdinformationexchange.org/phpBB3/viewtopic.php?f=3&amp;t=66451&amp;sid=a8d4fb0690166bbb208d4165dba2dff1"
   target="_new">this forum</a>.</span></p>

<h2><span style="FONT-SIZE: 12pt">NorthWest Scale Aero-Modellers</span></h2>

<p><span style="FONT-SIZE: 12pt">You&nbsp;might be interested in this video published by NorthWest Scale
Aero-Modellers.&nbsp; It was sent to us by the Director of their group,</span> <span style="FONT-SIZE: 12pt">Roly
Worsfold.&nbsp; His comments in the email were:&nbsp;</span></p>

<p class="ecxMsoNormal"><span style="FONT-SIZE: 12pt">"The video was made to inform RC Scale Aero-Modellers about
RC Scale Aero-Modelling - focusing on the model Aero-Modeling community with the hopes it will help to promote more
RC Scale events in Canada and United States.</span></p>

<p class="ecxMsoListParagraph"
   style="TEXT-INDENT: -18pt"><span style="FONT-FAMILY: Symbol"><span>·<span style=
   'FONT: 7pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></span> Early
   feedback (before we finished the video content) from novice/experienced modellers and some of their partners is
   that it removes some of the mysteries and helps them more clearly understand this aspect of the hobby. We hope
   you find the video similar to yourselves".</p>

<p><span style="FONT-SIZE: 12pt">If you would like to contact him about this video or their group, Roly's email
is:<script language="JavaScript">
<!--
emailname = "rolydd"
emailserver ="telus.net"
document.write("<a href='mailto:" + emailname + "@" + emailserver + "'>");
document.write(emailname + "@" + emailserver);
document.write("</a>");
-->
</script></span></p><iframe width="640" height="360" src="//www.youtube.com/embed/hXwoWIMs8Iw?feature=player_detailpage" frameborder="0" allowfullscreen></iframe>
</td></tr></table></td>
