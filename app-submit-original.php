...
<input type="hidden" name="hosted_button_id" value="BUFYL6EA384D6">
<table>
<tr><td><input type="hidden" name="on0" value="Membership Fee">Membership Fee</td></tr><tr><td><select name="os0">
	<option value="Junior">Junior $25.00 CAD</option>
	<option value="Social member">Social member $30.00 CAD</option>
        <option value="Associate member">Associate member $50.00 CAD</option>
	<option value="Associate member with key">Associate member with key $55.00 CAD</option>
	<option value="Full">Full $75.00 CAD</option>
	<option value="Full with key">Full with key $80.00 CAD</option>
	<option value="Half year with Initiation">Half year with Initiation $100.00 CAD</option>
	<option value="Half year with initiation and key">Half year with initiation and key $105.00 CAD</option>
	<option value="New Full member">New Full member $125.00 CAD</option>
	<option value="New member with key">New member with key $130.00 CAD</option>
...
old code with my paypal account:
...
<form method="post"
    ...
    <p align="left"><input alt="PayPal Services"
           src="https://www.paypalobjects.com/en_US/i/btn/btn_paynowCC_LG.gif"
           type="image"
           border="0"
           name="submit"></p><img title=""
...
<br><p> <align="left">If you prefer to pay your fee online by check, mail it to the Club Treasurer
at:</p>
