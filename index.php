...
<html>
<head>
<title>PDQ Flyers - HOME</title>
<meta NAME="Keywords" Content="PDQ">
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=UTF-8">
<link type="text/css" rel="stylesheet" href="xsp_styles.css">
<link rel="canonical" href="http://www.pdqflyers.com/" /><!-- Start VisualSlideShow.com HEAD section -->
	<link rel="stylesheet" type="text/css" href="slideshows/homepage/engine/css/slideshow.css" media="screen" />
	<style type="text/css">.slideshow a#vlb{display:none}</style>
	<script type="text/javascript" src="slideshows/homepage/engine/js/mootools.js"></script>
	<script type="text/javascript" src="slideshows/homepage/engine/js/visualslideshow.js"></script>
	<!-- End VisualSlideShow.com HEAD section --><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><!--
Notes:
Visual Slideshow is used throughout the website for slide show presentations and Visual Lightbox is used for multiple photo displays.  Both put a script in the Head area and code into the Body area of a page which is to show the slide show or images.  Two folders: data and engine must be ftp'd into the web site to provide code and data.  All images (data) are stored in a folder named "data" at the root level (in the case of the Members section, at the base level of that website).  It's ok to have them all in the same folder and every once in a while (after several slideshows have been retired) they should be deleted and regenerated from the current set of slideshows.  Each slide show must have its own engine folder, so these are all in the root folder "slideshows".  The individual engines are in folders named after the page name on which they occur.  When the Head section is inserted onto the page, the href and src verbs have to be modified by adding "slideshows/pagename/" in front of the named URL.
--> 

<h2><span><span style="FONT-SIZE: 20pt"><span style="FONT-SIZE: 20pt"><font color="#0000ff">PDQ Flyers Home
Page</font></span></span></span></h2>

<h4><span>Who we are...</span></h4>

<p><span>PDQ Flyers is a model aircraft club with about 90 members.&nbsp;All of us&nbsp;have a love of aircraft and
...
<p><span>In June, 2013, Shaw TV filmed some of our flyers in action and published the video on the "Go Island"
section of their website.&nbsp; It's available on YouTube <a href="http://www.youtube.com/watch?v=IRUzSukrQ0M"
   target="_new">here</a>&nbsp;(for some reason, it takes a minute or two to load, so be patient...).</span></p>

<h4><span>Why you might be interested...</span></h4>

<table style=
"HEIGHT: 24px; BORDER-TOP-COLOR: ; WIDTH: 722px; BORDER-LEFT-COLOR: ; BORDER-BOTTOM-COLOR: ; BORDER-RIGHT-COLOR:"
       cellspacing="1"
       cellpadding="0"
       border="0">
    <tbody>
        <tr>
            <td style="BORDER-TOP-COLOR: ; BORDER-LEFT-COLOR: ; BORDER-BOTTOM-COLOR: ; BORDER-RIGHT-COLOR:"
                ...
                flying location, or indoor flying) to&nbsp;see what we are all about and to meet our
                members.</span></span></span></p>
            </td>

            <td id="homepagepicscontent"
                style=
                "BORDER-TOP-COLOR: ; WIDTH: 330px; BORDER-LEFT-COLOR: ; BORDER-BOTTOM-COLOR: ; BORDER-RIGHT-COLOR:"
                valign="top"
                align="right">
                <div align="right">
                    ...
                    <div id="show"
                        ...
                        <div class="slideshow-images">
                            <a href="#"><img id="slide-0"
                                 title="SLplane3"
                                 alt="SLplane3"
                                 src="data/images/slplane3.jpg"></a> <a href="#"><img id="slide-1"
                                 title="rdon1"
                                 alt="rdon1"
                                 src="data/images/rdon1.jpg"></a> <a href="#"><img id="slide-2"
                                 title="cpoa1"
                                 alt="cpoa1"
                                 src="data/images/cpoa1.jpg"></a> <a href="#"><img id="slide-3"
                                 title="normal_PhilipL_04"
                                 alt="normal_PhilipL_04"
                                 src="data/images/normal_philipl_04.jpg"></a> <a href="#"><img id="slide-4"
                                 title="Larry and Venture"
                                 alt="Larry and Venture"
                                 src="data/images/larry_and_venture.jpg"></a> <a href="#"><img id="slide-5"
                                 title="PDQScaleFly25-06-10055"
                                 alt="PDQScaleFly25-06-10055"
                                 src="data/images/pdqscalefly250610055.jpg"></a> <a href="#"><img id="slide-6"
                                 title="normal_Bob_w_01"
                                 alt="normal_Bob_w_01"
                                 src="data/images/normal_bob_w_01.jpg"></a> <a href="#"><img id="slide-7"
                                 title="Slplane1"
                                 alt="Slplane1"
                                 src="data/images/slplane1.jpg"></a> <a href="#"><img id="slide-8"
                                 title="normal_SabrinaL_01"
                                 alt="normal_SabrinaL_01"
                                 src="data/images/normal_sabrinal_01.jpg"></a> <a href="#"><img id="slide-9"
                                 title="P1040202"
                                 alt="P1040202"
                                 src="data/images/p1040202.jpg"></a> <a href="#"><img id="slide-10"
                                 title="Pater Jubbs sBach"
                                 alt="Pater Jubbs sBach"
                                 src="data/images/pater_jubbs_sbach.jpg"></a> <a href="#"><img id="slide-11"
                                 title="PDQScaleFly27-06-10008"
                                 alt="PDQScaleFly27-06-10008"
                                 src="data/images/pdqscalefly270610008.jpg"></a> <a href="#"><img id="slide-12"
                                 title="pjub1"
                                 alt="pjub1"
                                 src="data/images/pjub1.jpg"></a> <a href="#"><img id="slide-13"
                                 title="bwil1"
                                 alt="bwil1"
                                 src="data/images/bwil1.jpg"></a> <a href="#"><img id="slide-14"
                                 title="Red Baron"
                                 alt="Red Baron"
                                 src="data/images/red_baron.jpg"></a> <a href="#"><img id="slide-15"
                                 title="shug1"
                                 alt="shug1"
                                 src="data/images/shug1.jpg"></a> <a href="#"><img id="slide-16"
                                 title="dvar1"
                                 alt="dvar1"
                                 src="data/images/dvar1.jpg"></a> <a href="#"><img id="slide-17"
                                 title="SLplane4"
                                 alt="SLplane4"
                                 src="data/images/slplane4.jpg"></a> <a href="#"><img id="slide-18"
                                 title="SLplane5"
                                 alt="SLplane5"
                                 src="data/images/slplane5.jpg"></a> <a href="#"><img id="slide-19"
                                 title="normal_Charles_H_01"
                                 alt="normal_Charles_H_01"
                                 src="data/images/normal_charles_h_01.jpg"></a> <a href="#"><img id="slide-20"
                                 title="SLplane6"
                                 alt="SLplane6"
                                 src="data/images/slplane6.jpg"></a> <a href="#"><img id="slide-21"
                                 title="SuperSportster40"
                                 alt="SuperSportster40"
                                 src="data/images/supersportster40.jpg"></a> <a href="#"><img id="slide-22"
                                 title="Bill Martins ARF"
                                 alt="Bill Martins ARF"
                                 src="data/images/bill_martins_arf.jpg"></a> <a href="#"><img id="slide-23"
                                 title="trow1"
                                 alt="trow1"
                                 src="data/images/trow1.jpg"></a> <a href="#"><img id="slide-24"
                                 title="unk1"
                                 alt="unk1"
                                 src="data/images/unk1.jpg"></a> <a href="#"><img id="slide-25"
                                 title="unk2"
                                 alt="unk2"
                                 src="data/images/unk2.jpg"></a> <a href="#"><img id="slide-26"
                                 title="unknown"
                                 alt="unknown"
                                 src="data/images/unknown.jpg"></a> <a href="#"><img id="slide-27"
                                 title="WW1 bi-plane"
                                 alt="WW1 bi-plane"
                                 src="data/images/ww1_biplane.jpg"></a>
                        </div><a id="vlb"
                             href="http://visualslideshow.com/">Slideshow In HTML by VisualSlideshow.com v1.7</a>
                    </div><!-- End VisualSlideShow.com BODY section -->
                </div>
            </td>
        </tr>
    </tbody>
...
<p><span><span>If you're driving by our flying field south of Parksville and see that our gate is open,&nbsp;you
are welcome to&nbsp;come in to check&nbsp;us out.&nbsp; You&nbsp;must&nbsp;sign the DND waiver book as soon as you
arrive at the field.&nbsp; It has a blue cover&nbsp;and is kept in our shelter.&nbsp; Also, please remember that
v</span><span><span>isitors must park in the upper parking area and stay behind the flight
...
<a href="event-schedule.php">event</a> of the year is the scale model weekend.&nbsp; You can see the real thing in
...
<ul>
    ...
    training programs, club rules and processes, and links to other websites that might be of
    interest;</span>&nbsp;</li>
