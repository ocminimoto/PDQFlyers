...
<html>
<head>
<title>PDQ Flyers - Membership Data</title>
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><p><span style="FONT-SIZE: 20pt"><strong><font color="#0000ff">Membership&nbsp;Data
Update&nbsp;Request</font></strong></span></p>

<h3>Instructions</h3>

<p>To initiate or renew your PDQ Flyers Club Membership, a MAAC number is required, as all Club membership data is
keyed on the MAAC number.&nbsp; It does not have to be valid for the application year to complete the application
or make the Club dues payment, but must be activated in order to receive your Club membership card.</p>

<p>Enter your MAAC number and last name in the fields below and press the "Apply for Membership" button and you
will be re-directed to a page where you can enter information about yourself and initiate the application.</p>

<p>If you are a renewing Member, the personal information that you supplied in the past&nbsp;will be displayed and
you will be able to modify those fields that require change.</p>

<div id="entries">
    <form method="post"
          action="data-updater.php">
        <fieldset id="contact">
            <p><legend><strong>Contact</strong> <strong>Information</strong></legend></p>
        ...
        <p><button type="submit"><img title="Submit Request"
             alt="Submit Request"
             src="procede.jpg"
             width="50"
             height="50"> Retrieve my Membership Data</button></p>
    </form>
</div>
</td></tr></table></td>
