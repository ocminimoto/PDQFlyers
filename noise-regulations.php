...
<html>
<head>
<title>PDQ Flyers - Noise Regulations</title>
...
<link rel="canonical" href="http://www.pdqflyers.com/noise-regulations.php" /><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<tr><td>
 ...
 <span class="xsp1INFO_BAR_MENU"><a class="mainlinksINFO_BAR_MENU" href="photobucket.php" target="">PhotoBucket</a></span>
 ...
 <span class="xsp1INFO_BAR_MENU"><a class="mainlinksINFO_BAR_MENU" href="rss-to-igoogle.php" target="">RSS&nbsp;to&nbsp;iGoogle</a></span>
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><p><span style="FONT-SIZE: 20pt"><strong><font color="#0000ff">Noise Regulations</font></strong></span></p>

<h4>Current Rules:</h4>

<ol>
    <li>No&nbsp;airplane shall&nbsp;exceed a maximum noise requirement of 92 db measured at 6 meters. The noise
    meter shall be set to the "A" weighting scale and "slow response" setting.</li>

    <li>The noise reading used will be the one measured at the loudest aircraft orientation.</li>

    <li>Flying will not commence before 10 a.m. and will end at sunset.</li>

    <li>A maximum of 5 aircraft may be airborne at any one time.</li>

    <li>After 5:00 p.m., no more than 3 aircraft may be airborne at one time.</li>

    <li>Aircraft that are above 92db but not more than 98 db, will be allowed to fly only after meeting all of the
    following conditions:</li>
</ol>

<div style="MARGIN-LEFT: 2em">
    <ul>
        <li>Only the 1 aircraft is airborne at any one time.</li>

        <li>The pilot must get the agreement of all other pilots not to fly at the same time.</li>

        <li>No flying of these aircraft after 5:00 p.m. under any circumstances</li>
    </ul>
</div>

<h4>Proposed Additions:</h4>

<p>The following recommendations have been forwarded to the PDQ Flyers' Directors for approval with&nbsp;a request
that in the interim all members abide by them.</p>

<p class="bold_large">1. "FLY YOUR AIRCRAFT AS CLOSE TO THE FIELD AS POSSIBLE".</p>
...
<ul>
    ...
    <li>
        <div class="bold_large">
            This means not very far past the trees on the edge of the runway.<br>
            The closer you fly to the field the less impact you have on our neighbours.
        </div>
    </li>
</ul>

<p class="bold_large">2. "A MODEL AIRCRAFT STICKERING SYSTEM FOR THE FOLLOWING ENGINES".</p>
...
<p class="bold_large center">This testing must be done by the noise committee members.<br>
Once tested the aircraft will have a sticker attached to it for verification.<br>
These tests will be recorded as well.<br>
<br>
The committee has not recommended any changes to the present noise rules,<br>
"only strict compliance to them".</p>

<p class="bold_large center hiliteyellow">Absolutely no flying any aircraft with the above engines after 5 PM<br>
until tested and certified by the noise committee.</p>

<p class="bold_large center hiliteyellow">The committee has recommended that violators be dealt with<br>
immediately and harshly.</p>
</td></tr></table></td>
