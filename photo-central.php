...
<html>
<head>
<title>PDQ Flyers - Photo Central</title>
...
<link rel="canonical" href="http://www.pdqflyers.com/photo-central.php" /><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><p><strong><font color="#0000ff"><span style="FONT-SIZE: 20pt">Photo Central</span></font></strong></p>

<p><span style="FONT-SIZE: 12pt">We wanted to make it easy for Members to upload their photos to the web for
general viewing so that those who weren't&nbsp;at that particular event&nbsp;can get a feel for what happened as
well.</span></p>

<p>After attempting to use PhotoBucket as a photo upload and album management tool, we found that there were too
many problems, so&nbsp;we&nbsp;have installed a new procedure for uploading photos for the webmaster to post.&nbsp;
That procedure is described in the Member's&nbsp;Section on a page called "Upload Photos".&nbsp;</p>

<h4>Photo Albums</h4>

<p>This balance of this section of the site is a&nbsp;recap and pointer to&nbsp;of all of the photos that have been
taken by members over the years. In each case, there is a direct link to the photo album where you can view
individual photographs and a slide show presented in case you just want to view them all.</p>
</td></tr></table></td>
