...
<html>
<head>
<title>PDQ Flyers - Member Data Update Request</title>
...
<link rel="canonical" href="http://www.pdqflyers.com/member-data-update-request.php" /><link type="text/css" rel="stylesheet" href="INFO_BAR_MENU.css">
...
<td class="XSP_CENTER_PANEL" rowspan="2"><table class="XSP_CENTER_PANEL" cellpadding="0" cellspacing="0" border="0"><tr><td class="XSP_MAIN_PANEL"><p><span style="FONT-SIZE: 20pt"><strong><font color="#0000ff">Member Data Update
Request</font></strong></span></p>

<h3>Member Data Update</h3>

<p>To make changes to&nbsp;your contact information or preferences in our Club Membership Database,&nbsp;enter your
MAAC number and last name in the fields below and you will be re-directed to a page where your personal
information&nbsp;will be displayed and you will be able to modify those fields that require change.</p>

<form method="post"
      action="data-update.php">
    <p class="legend"><b>Contact Information</b></p>

    <fieldset id="contact">
        <label>MAAC#:</label> <input size="12"
                  name="maac_info"><br>
        <label>Last Name:</label> <input size="30"
                  name="contact_lname">
    </fieldset>

    <p id="buttons"><input type="submit"
           value="Update My Data"></p>
</form>
</td></tr></table></td>
